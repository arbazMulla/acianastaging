...
+(function (t) {
      ...
      (i.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          if (d) {
            ...
            (a =
              "bottom" == a && c.bottom + u > f.bottom
                ? "top"
                : "top" == a && c.top - u < f.top
                ? "bottom"
                : "right" == a && c.right + p > f.width
                ? "left"
                : "left" == a && c.left - p < f.left
                ? "right"
                : a),
  ...
  (function (t) {
    t.fn.viewportChecker = function (e) {
      ...
      t.extend(i, e);
      var o = this,
        s = { height: t(i.scrollBox).height(), width: t(i.scrollBox).width() };
      return (
        (this.checkElements = function () {
          ...
          i.scrollHorizontal
            ...
            o.each(function () {
              ...
              if (
                (o.data("vp-add-class") &&
                  (a.classToAdd = o.data("vp-add-class")),
                o.data("vp-remove-class") &&
                  (a.classToRemove = o.data("vp-remove-class")),
                o.data("vp-add-class-full-view") &&
                  (a.classToAddForFullView = o.data("vp-add-class-full-view")),
                o.data("vp-keep-add-class") &&
                  (a.removeClassAfterAnimation = o.data(
                    "vp-remove-after-animation"
                  )),
                o.data("vp-offset") && (a.offset = o.data("vp-offset")),
                o.data("vp-repeat") && (a.repeat = o.data("vp-repeat")),
                o.data("vp-scrollHorizontal") &&
                  (a.scrollHorizontal = o.data("vp-scrollHorizontal")),
                o.data("vp-invertBottomOffset") &&
                  (a.scrollHorizontal = o.data("vp-invertBottomOffset")),
                t.extend(r, i),
                t.extend(r, a),
                !o.data("vp-animated") || r.repeat)
              ) {
                String(r.offset).indexOf("%") > 0 &&
                  (r.offset = (parseInt(r.offset) / 100) * s.height);
                var l = r.scrollHorizontal ? o.offset().left : o.offset().top,
                  d = r.scrollHorizontal ? l + o.width() : l + o.height(),
                  c = Math.round(l) + r.offset,
                  p = r.scrollHorizontal ? c + o.width() : c + o.height();
                r.invertBottomOffset && (p -= 2 * r.offset),
                  c < n && p > e
                    ? (o.removeClass(r.classToRemove),
                      o.addClass(r.classToAdd),
                      r.callbackFunction(o, "add"),
                      d <= n && l >= e
                        ? o.addClass(r.classToAddForFullView)
                        : o.removeClass(r.classToAddForFullView),
                      o.data("vp-animated", !0),
                    ...
                    : o.hasClass(r.classToAdd) &&
                      r.repeat &&
                      (o.removeClass(
                        r.classToAdd + " " + r.classToAddForFullView
                      ),
                      r.callbackFunction(o, "remove"),
                      o.data("vp-animated", !1));
              }
            });
        }),
      ...
      (e.prototype.selectHandler = function (e) {
        ...
        return (
          ...
          i.slideCount <= i.options.slidesToShow
            ? (i.setSlideClasses(s), void i.asNavFor(s))
        ...
        return (
          ...
          d.slideCount <= d.options.slidesToShow
            ...
            : (!1 === e && d.asNavFor(t),
              ...
              (0 > t || t > d.getDotCount() * d.options.slidesToScroll)
                ? void (
                    !1 === d.options.fade &&
                    ((o = d.currentSlide),
                    !0 !== i
                ...
                : !1 === d.options.infinite &&
                  ...
                  (0 > t || t > d.slideCount - d.options.slidesToScroll)
                ? void (
                    !1 === d.options.fade &&
                    ((o = d.currentSlide),
                    !0 !== i
  ...
  (function (t) {
    ...
    var e,
      ...
      S = function () {
        t.magnificPopup.instance ||
          ((e = new v()), e.init(), (t.magnificPopup.instance = e));
      },
      $ = function () {
    ...
    (v.prototype = {
      ...
      updateItemHTML: function () {
        ...
        var o = i.type;
        if (
          (k("BeforeChange", [e.currItem ? e.currItem.type : "", o]),
          (e.currItem = i),
          !e.currTemplate[o])
        ) {
          var n = !!e.st[o] && e.st[o].markup;
          k("FirstMarkupParse", n), (e.currTemplate[o] = !n || t(n));
        }
    ...
    var x,
      ...
      A = "inline",
      O = function () {
        E && (I.after(E.addClass(x)).detach(), (E = null));
      };
        ...
        getInline: function (i, o) {
          if ((O(), i.src)) {
            ...
            if (n.length) {
              ...
              r &&
                r.tagName &&
                (I || ((x = s.hiddenClass), (I = T(x)), (x = "mfp-" + x)),
                (E = n.after(I).detach().removeClass(x))),
    ...
    t.magnificPopup.registerModule("image", {
      ...
      proto: {
        ...
        getImage: function (i, o) {
          ...
          return (
            e._parseMarkup(o, { title: M(i), img_replaceWith: i.img }, i),
            e.resizeImage(),
            i.hasSize
              ? (L && clearInterval(L),
                i.loadError
  ...
  (function (t) {
    t(document).on("click", ".loadmore", function (e) {
      ...
      var i = t(this),
        o = i.attr("href");
      i.attr("disabled") ||
        (i.addClass("loading").attr("disabled", !0),
        i.find("span").html("Loading..."),
        t("<div>").load(o + " #loadmorecontainer", function () {
          t("#loadmorecontainer").append(
            t(this).find("#loadmorecontainer").html()
          ),
            i.parents(".load-more").removeAttr("disabled").remove();
        }));
    });
    var e = function (t, e, i, o) {
    ...
    t(document).on("click", ".share-popup", function (i) {
      var o = t(this);
      e(o.attr("href"), o.find(".text").html(), 580, 470), i.preventDefault();
    }),
      t(document).on("click", ".nav-toggle", function (e) {
        t(this).toggleClass("open"), t("html").toggleClass("nav-open");
      }),
      t(".animate-it").addClass("animate-hidden").viewportChecker({
        classToAdd: "animate-visible animated fadeInUp",
        offset: 100,
      }),
      t(".open-demo-popup").magnificPopup({ type: "inline", midClick: !0 }),
      t(".solution-carousel").slick({
        dots: !1,
        infinite: !0,
        autoplay: !1,
        speed: 500,
...
jQuery(document).ready(function () {
  jQuery("#myvideo").removeAttr("controls");
  jQuery("#myvideo").mouseenter(function () {
    console.log(this);
    this.setAttribute("controls", "controls");
  });
  jQuery("#myvideo").mouseleave(function () {
...
jQuery(document).ready(function() {
   jQuery('.plan.pro').show(); // Show the default plan
   jQuery('.premium').addClass('hide');
      jQuery('.switch-button').click(function() {
        jQuery('.premium').removeClass('hide');
        jQuery('.premiumButton').addClass('visible');
        var targetPlan = jQuery(this).data('target');
        
        jQuery('.plan').hide();
        jQuery('.plan.' + targetPlan).show();
